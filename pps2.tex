...
\begin{itemize}
  ...
  \ref{arbolEjecucion} se puede observar un ejemplo de un método con su correspondiente árbol de ejecución. Cabe destacar que el programa en este punto no contiene ciclos,
