...
\hyphenation{he-rra-mien-ta es-cri-ban va-lor va-lo-res in-he-ren-te e-xis-ta
	     o-pe-ra-do-res} %Indico como deben dividirse las palabras que s e ``cortan'' mal cuando se justifica el texto
...
\newpage
\appendix
\section{Pre proceso}\label{aped.A}
...
\section{Y más cosas aún}\label{aped.B}
Y más cosas aún.
