...
\hyphenation{he-rra-mien-ta es-cri-ban va-lor va-lo-res in-he-ren-te e-xis-ta
	     o-pe-ra-do-res e-xis-ten} %Indico como deben dividirse las palabras que s e ``cortan'' mal cuando se justifica el texto
...
Actualmente consta de tres opciones generales.
    ...
    \begin{figure}
    \centering
    \includegraphics[width=0.75\textwidth]{screenshots/testGenerados}
    \caption{Test Generados}
    \label{fig:testGenerados}
    \end{figure}
